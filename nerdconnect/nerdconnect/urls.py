...
from authentication.views import signup, logout_view, login_view, detail_section, UpdateDetails, DeleteAccount, index
from home.views import home, CreatePost,feedSection, SomeUser, Search, UserPosts
